...
sealed class Screen(val route: String, val label: String, val icon: ImageVector) {
    ...
    object AddCategory : Screen("add_category", "Add Category", Icons.Filled.Category)
    object CustomizeDashboard : Screen("customize_dashboard", "Customize", Icons.Filled.Edit)
}
